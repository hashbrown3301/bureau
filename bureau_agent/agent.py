...
Flow:
  validate_input -> normalize_and_compute -> run_consistency_check
...
from .tools import run_consistency_check, generate_summary
...
def create_bureau_agent():
    ...
    workflow.add_conditional_edges(
        ...
        {
            "normalize_and_compute": "normalize_and_compute",
            "finalize_output": "finalize_output",
        },
    )

    workflow.add_edge("normalize_and_compute", "run_consistency_check")
    workflow.add_edge("run_consistency_check", "generate_summary")
